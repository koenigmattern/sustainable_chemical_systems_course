...
class GNN(nn.Module):
    def __init__(self, num_layer=3, drop_ratio=0.5, conv_dim=100, gnn_type='NNConv', JK='last', graph_pooling='max', neurons_message=None,
...
class GNN_with_fp(nn.Module):
    # same as class GNN, but additionally giving the pooling layer ("GNN fingerprint") as output
    def __init__(self, num_layer=3, drop_ratio=0.5, conv_dim=100, gnn_type='NNConv', JK='last', graph_pooling='max',
                 neurons_message=None,
                 mlp_layers=None, mlp_dims=None):
        super(GNN_with_fp, self).__init__()
